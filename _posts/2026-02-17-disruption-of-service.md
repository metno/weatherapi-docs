...
Unfortunately, api.met.no (along with most other services from MET Norway) was
...
to our other line didn't work as expected. Sorry about that.

**Update**: After trying to fix the failover issue, we experienced an occurrence
...
from the server room on a rail as we speak.
