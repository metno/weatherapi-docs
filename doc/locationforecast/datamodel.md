...
Historical short term forecasts for the Nordic region are available for download from our [thredds server](https://thredds.met.no/thredds/metno.html). For more information, see the [NPW Wiki](https://github.com/metno/NWPdocs/wiki).
